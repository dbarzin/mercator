...
class MassStorePeripheralRequest extends FormRequest
{
    ...
    {
        // On récupère les règles du StorePeripheralRequest classique
        $storeRules = (new StorePeripheralRequest())->rules();
