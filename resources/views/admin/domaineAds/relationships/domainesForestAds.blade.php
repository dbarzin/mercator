...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-domainesForestAds">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  $('.datatable-domainesForestAds:not(.ajaxTable)').DataTable({ buttons: dtButtons })
