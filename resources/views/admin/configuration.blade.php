    ...
    <div class="card-body">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <select class="form-control select2" name="expire_delay" id="expire_delay">
                <option value="1" {{ $expire_delay=="1" ? 'selected' : '' }}>1 jour</option>
                <option value="7" {{ $expire_delay=="7" ? 'selected' : '' }}>7 jours</option>
                <option value="15" {{ $expire_delay=="15" ? 'selected' : '' }}>15 jours</option>
                <option value="30" {{ $expire_delay=="30" ? 'selected' : '' }}>1 mois</option>
                <option value="60" {{ $expire_delay=="60" ? 'selected' : '' }}>2 mois</option>
                <option value="90" {{ $expire_delay=="90" ? 'selected' : '' }}>3 mois</option>
            </select>
            </div>
            ...
            <select class="form-control select2" name="check_frequency" id="check_frequency">
                <option value="0" {{ $check_frequency=="0" ? 'selected' : '' }}>jamais</option>
                <option value="1" {{ $check_frequency=="1" ? 'selected' : '' }}>jour</option>
                <option value="2" {{ $check_frequency=="2" ? 'selected' : '' }}>semaine</option>
                <option value="3" {{ $check_frequency=="3" ? 'selected' : '' }}>mois</option>
            </select>
            </div>
