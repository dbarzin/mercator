            ...
            <div class="col-sm-1">
                <div class="form-check">
                    ...
                    <div class="form-switch">
                        <input class="form-check-input" type="checkbox" id="active" name="active" {{ old('active', $active) ? "checked" : "" }}/>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input class="date form-control" type="date" name="install_date" id="install_date" value="{{ old('install_date') }}">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input class="date form-control" type="date" id="update_date" name="update_date" value="{{ old('update_date') }}">
