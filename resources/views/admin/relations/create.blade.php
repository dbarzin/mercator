        ...
        <form method="POST" action="{{ route("admin.relations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('inportance') ? 'is-invalid' : '' }}" name="inportance" id="inportance">
                    ...
                    <option value="1" {{ old('inportance') == 1 ? 'selected' : '' }}>Faible</option>
                    <option value="2" {{ old('inportance') == 2 ? 'selected' : '' }}>Moyen</option>
                    <option value="3" {{ old('inportance') == 3 ? 'selected' : '' }}>Fort</option>
                    <option value="4" {{ old('inportance') == 4 ? 'selected' : '' }}>Critique</option>
                </select>
