...
<div class="card">
    ...
    <div class="card-footer">
        {{ trans('global.created_at') }} {{ $physicalSecurityDevice->created_at->format(trans('global.timestamp')) ?? '' }} |
        {{ trans('global.updated_at') }} {{ $physicalSecurityDevice->updated_at->format(trans('global.timestamp')) ?? '' }} 
    </div>
</div>
@endsection