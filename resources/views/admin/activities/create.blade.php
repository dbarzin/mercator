                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="number" class="form-control" id="maximum_tolerable_downtime_days"
                                               name="maximum_tolerable_downtime_days" min="0" max="365"
                                               value="{{ old('maximum_tolerable_downtime_days', '') }}">
                                    </td>
                                    <td>
                                        <span class="help-block">{{ trans('global.hours') }}</span>
                                        <input type="number" class="form-control" id="maximum_tolerable_downtime_hours"
                                               name="maximum_tolerable_downtime_hours" min="0" max="24"
                                               value="{{ old('maximum_tolerable_downtime_hours', '') }}">
                                    </td>
                                    <td>
                                        <span class="help-block">{{ trans('global.minutes') }}</span>
                                        <input type="number" class="form-control" id="maximum_tolerable_downtime_minute"
                                               name="maximum_tolerable_downtime_minutes" min="0" max="60"
                                               value="{{ old('maximum_tolerable_downtime_minutes', '') }}">
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="number" class="form-control" id="maximum_tolerable_data_loss_days"
                                               name="maximum_tolerable_data_loss_days" min="0" max="365"
                                               value="{{ old('maximum_tolerable_data_loss_days', '') }}">
                                    </td>
                                    <td>
                                        <span class="help-block">{{ trans('global.hours') }}</span>
                                        <input type="number" class="form-control" id="maximum_tolerable_data_loss_hours"
                                               name="maximum_tolerable_data_loss_hours" min="0" max="24"
                                               value="{{ old('maximum_tolerable_data_loss_hours', '') }}">
                                    </td>
                                    <td>
                                        <span class="help-block">{{ trans('global.minutes') }}</span>
                                        <input type="number" class="form-control"
                                               id="maximum_tolerable_data_loss_minutes"
                                               name="maximum_tolerable_data_loss_minutes" min="0" max="60"
                                               value="{{ old('maximum_tolerable_data_loss_minutes', '') }}">
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="number" class="form-control" id="recovery_time_objective_days"
                                               name="recovery_time_objective_days" min="0" max="365"
                                               value="{{ old('recovery_time_objective_days', '') }}">
                                    </td>
                                    <td>
                                        <span class="help-block">{{ trans('global.hours') }}</span>
                                        <input type="number" class="form-control" id="recovery_time_objective_hours"
                                               name="recovery_time_objective_hours" min="0" max="24"
                                               value="{{ old('recovery_time_objective_hours', '') }}">
                                    </td>
                                    <td>
                                        <span class="help-block">{{ trans('global.minutes') }}</span>
                                        <input type="number" class="form-control" id="recovery_time_objective_minutes"
                                               name="recovery_time_objective_minutes" min="0" max="60"
                                               value="{{ old('recovery_time_objective_minutes', '') }}">
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type="number" class="form-control" id="recovery_point_objective_days"
                                               name="recovery_point_objective_days" min="0" max="365"
                                               value="{{ old('recovery_point_objective_days', '') }}">
                                    </td>
                                    <td>
                                        <span class="help-block">{{ trans('global.hours') }}</span>
                                        <input type="number" class="form-control" id="recovery_point_objective_hours"
                                               name="recovery_point_objective_hours" min="0" max="24"
                                               value="{{ old('recovery_point_objective_hours', '') }}">
                                    </td>
                                    <td>
                                        <span class="help-block">{{ trans('global.minutes') }}</span>
                                        <input type="number" class="form-control" id="recovery_point_objective_minutes"
                                               name="recovery_point_objective_minutes" min="0" max="60"
                                               value="{{ old('recovery_point_objective_minutes', '') }}">
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('drp_link') ? 'is-invalid' : '' }}" type="text"
                                   name="drp_link" id="drp_link" value="{{ old('drp_link', '') }}" maxlength=256/>
