        ...
        <div class="col-md-6">
            <div class="card mx-4">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted">{{ (env('APP_NAME') === null) || (env('APP_NAME') === "Laravel") ? "Mercator" : env('APP_NAME') }}
                        :: Login</p>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <button type="submit" class="btn btn-primary px-4" id="login-button"
                                        dusk="login-button">
                                    {{ trans('global.login') }}
                                </button>
                            </div>
                    ...
                    @if(env('KEYCLOAK') === 'enable')
                        ...
                        <div class="text-right mt-3">
                            <a href="{{ route('login.keycloak') }}"
                               class="btn btn-secondary">{{ (env('KEYCLOAK_BTN_LABEL') === null) ? "Keycloak" : env('KEYCLOAK_BTN_LABEL') }}</a>
                        </div>
                    @endif
