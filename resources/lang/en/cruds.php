...
'activity' => [
    ...
    'logicalFlow' => [
        ...
        'fields' => [
            ...
            'description_helper' => '',
            'priority' => 'Priority',
            'priority_helper' => 'The order in which rules are applied. Higher priority rules are applied first.',
            'action' => 'Action',
            'action_helper' => 'Action to take for matching traffic: Accept, Reject, or Block.',
            'users' => 'Users',
