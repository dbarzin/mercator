...
CREATE TABLE `activities` (
  ...
  `recovery_time_objective` time DEFAULT NULL,
  `maximum_tolerable_downtime` time DEFAULT NULL,
  `recovery_point_objective` time DEFAULT NULL,
  `maximum_tolerable_data_loss` time DEFAULT NULL,
