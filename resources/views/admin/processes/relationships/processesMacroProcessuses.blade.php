...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-processesMacroProcessuses">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.macroProcessus.fields.id') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($macroProcessuses as $key => $macroProcess)
...
@endcan
  ...
  let table = $('.datatable-processesMacroProcessuses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
