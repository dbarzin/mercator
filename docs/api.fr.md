...
- [/api/dhcp-servers *(usage non recommendé)*](./model.fr.md#serveurs-dhcp)
- [/api/dnsservers *(usage non recommendé)*](./model.fr.md#serveurs-dns)
...
- [/api/storage-devices *(usage non recommendé)*](./model.fr.md#infrastructures-de-stockage)
