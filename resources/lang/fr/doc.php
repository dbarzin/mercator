...
return [
    'about' => [
        'p1' => "Mercator est une application Web permettant de gérer la cartographie d’un système d’information comme décrit dans le <a href='https://www.ssi.gouv.fr/guide/cartographie-du-systeme-dinformation/'>Guide pour la cartographie du Système d’information</a> de l’<a href='https://www.ssi.gouv.fr/'>ANSSI</a>. Le <a href='https://dbarzin.github.io/mercator/'>manuel utilisateur</a> et les <a href='https://www.github.com/dbarzin/mercator'>sources de l'application</a> sont disponibles sur Github.",
    ...
    'guide' => [
        ...
        'p4' => "Le guide « <a href='https://www.ssi.gouv.fr/entreprise/guide/cartographie-du-systeme-dinformation/' target='new'>Cartographie du système d’information – Guide d’élaboration en cinq étapes</a> » publié par l’ANSSI décrit dans la mise en place de cette démarche.",
        'title' => 'Guide',
    ],
];
