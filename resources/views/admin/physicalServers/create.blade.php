        ...
        <div class="row">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input class="form-control datetime" type="date" name="install_date" id="install_date" value="{{ old('install_date', '') }}">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input class="datetime form-control" type="date" id="update_date" name="update_date" value="{{ old('update_date', '') }}">
