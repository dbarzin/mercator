...
[<img src="images/homepage.fr.png" width="600">](images/homepage.fr.png)
...
* La répartition des objets de la cartographie par domaine
   ...
   [<img src="images/repartition.fr.png" width="600">](images/repartition.fr.png)

* La carte proportionnelle globale des objets de la cartographie

   [<img src="images/treemap.fr.png" width="600">](images/treemap.fr.png)
...
- Le bouton "Supprimer" permet de supprimer un élément de l'exploration de la cartographie.
   ...
   [<img src="images/explore.fr.png" width="600">](images/explore.fr.png)
