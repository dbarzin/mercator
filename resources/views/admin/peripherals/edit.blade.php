        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $peripheral->name) }}" required autofocus/>
                    @if($errors->has('name'))
		...
		[
            {
                ...
                imgWidth: '120px',
                imgHeight: '120px',
                selected: {{ $peripheral->icon_id === null ? "true" : "false"}},
            },
            @foreach($icons as  $icon)
            {
                ...
                imgWidth: '120px',
                imgHeight: '120px',
                selected: {{ $peripheral->icon_id === $icon ? "true" : "false" }},
            },
            @endforeach
        ];
