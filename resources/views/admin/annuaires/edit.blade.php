    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.annuaires.update", [$annuaire->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $annuaire->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $annuaire->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('solution') ? 'is-invalid' : '' }}" type="text" name="solution" id="solution" value="{{ old('solution', $annuaire->solution) }}">
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '/admin/annuaires/ckmedia', true);
                ...
                data.append('crud_id', {{ $annuaire->id ?? 0 }});
                xhr.send(data);
              });
            })
        }
