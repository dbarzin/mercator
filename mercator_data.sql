...
INSERT INTO `data_processing_document` (`data_processing_id`, `document_id`) VALUES (1,16),(2,17),(2,19);
...
INSERT INTO `entity_process` (`process_id`, `entity_id`) VALUES (1,1),(2,1),(3,1),(1,13),(3,13),(4,1),(7,3),(9,4),(2,8),(4,6),(4,7),(9,5),(1,9),(2,9),(3,9),(4,9),(9,9),(1,12),(1,2),(4,18),(3,19),(1,22),(4,23);
...
INSERT INTO `logical_servers` (`id`, `name`, `description`, `net_services`, `configuration`, `created_at`, `updated_at`, `deleted_at`, `operating_system`, `address_ip`, `cpu`, `memory`, `environment`, `disk`, `disk_used`, `install_date`, `update_date`, `attributes`, `patching_frequency`, `next_update`, `cluster_id`, `responsible`) VALUES (1,'SRV-1','<p>Description du serveur 1</p>','DNS, HTTP, HTTPS','<p>Configuration du serveur 1</p>','2020-07-12 16:57:42','2024-03-02 05:45:53',NULL,'Ubuntu 20.04','10.10.1.1, 10.10.10.1','2','8','PROD',60,NULL,'2023-11-04 00:00:00','2022-12-10 00:00:00','GRP-1',1,'2023-01-10',1,NULL),(2,'SRV-2','<p>Description du serveur 2</p>','HTTPS, SSH','<p>Configuration par défaut</p>','2020-07-30 10:00:16','2023-12-13 07:04:30',NULL,'Windows 10','10.50.1.2','2','5','PROD',100,NULL,NULL,'2023-11-30 00:00:00','GRP-1',12,'2024-11-30',4,NULL),(3,'SRV-3','<p>Description du serveur 3</p>','HTTP, HTTPS',NULL,'2021-08-26 14:33:03','2023-12-13 07:04:30',NULL,'Ubuntu 20.04','10.70.8.3','4','16','PROD',80,NULL,NULL,'2023-11-30 00:00:00','GRP-1',12,'2024-11-30',4,NULL),(4,'SRV-42','<p><i>The Ultimate Question of Life, the Universe and Everything</i></p>',NULL,'<p>Full configuration</p>','2021-11-15 16:03:59','2023-11-03 09:21:46',NULL,'OS 42','10.0.0.42','42','42 G','PROD',42,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,'SRV-4','<p>Description du serveur 4</p>',NULL,NULL,'2022-05-02 16:43:02','2023-12-13 07:04:30',NULL,'Ubunti 22.04 LTS','10.10.3.2','4','2','Dev',NULL,NULL,'2022-05-01 00:00:00','2023-11-30 00:00:00','GRP-1',12,'2024-11-30',2,NULL),(6,'SRV-5','<p>Description server 5</p>',NULL,'<p>configuration goes here !</p>','2022-06-27 10:27:02','2023-12-13 07:05:40',NULL,'Ubunti 22.04 LTS','10.10.43.3','18','12','Integration',500,NULL,'2022-06-27 00:00:00','2023-03-14 00:00:00',NULL,12,'2023-12-08',NULL,NULL),(7,'SRV-6','<p>Description du serveur 6</p>',NULL,'<p>Default configuration</p>','2024-01-31 08:53:15','2024-01-31 08:59:49',NULL,'Debian 34',NULL,'4','64','PROD',100,20,'2024-02-07 00:00:00','2024-01-31 00:00:00','GRP-2',6,'2024-07-31',1,NULL),(8,'SRV-7','<p>Description server 7</p>',NULL,'<p>No cluster</p>','2024-02-05 19:41:25','2024-02-05 19:41:25',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `routers` (`id`, `name`, `description`, `rules`, `created_at`, `updated_at`, `deleted_at`, `ip_addresses`) VALUES (1,'LROUT_00','<p>Description du routeur 1</p>','<p>liste des règles dans //serveur/liste.txt</p>','2020-07-13 17:32:25','2023-02-01 15:57:53',NULL,'10.50.1.1, 10.60.1.1, 10.70.1.1'),(2,'LROUT_01','<p>Description of router 01</p>','<p>list of rules :&nbsp;</p><ul><li>a</li><li>b</li><li>c</li><li>d</li></ul>','2021-09-21 13:47:47','2023-02-01 15:58:02',NULL,'10.10.0.1, 10.20.0.1, 10.30.0.1'),(3,'LROUT_02','<p>This is the second router</p>',NULL,'2021-09-21 13:52:16','2023-02-01 15:58:09',NULL,'10.30.1.1, 10.40.1.1');
...
-- Dump completed on 2024-03-02  8:08:20
