...
@section('title')
    {{ trans('global.edit') }} {{ $relation->name }}
@endsection
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        <div class="form-group">
                            <label for="responsible">{{ trans('cruds.application.fields.responsible') }}</label>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="date" name="start_date" id="start_date"
                                   value="{{ old('start_date', $relation->start_date) }}">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="date" name="end_date" id="end_date"
                                   value="{{ old('end_date', $relation->end_date) }}">
                        ...
                        <div class="form-check">
                            ...
                            <div class="form-switch">
                                <input class="form-check-input" type="checkbox" id="active"
                                       name="active" {{ $relation->active ? "checked" : "" }}>
                                <label class="form-check-label"
                                       for="active">{{ trans('cruds.relation.fields.active_helper') }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
                    ...
                    <table class="table-narrow" id="dynamicAddRemove">
                        ...
                        @foreach($values as $value)
                            <tr>
                                <td>
                                    <div class="col">
                                        <input type="date" name="dates[]" value="{{ $value->date_price }}"
                                               class="form-control"/>
                                    </div>
                                </td>
                                <td>
                                    <input type="text" name="values[]" value="{{ $value->price }}"
                                           class="form-control"/>
                                </td>
                                <td>
