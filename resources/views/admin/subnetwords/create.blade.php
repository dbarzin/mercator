...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.subnetwords.store") }}" enctype="multipart/form-data">
            @csrf
          ...
          <div class="row">
            <div class="col-sm">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('ip_allocation_type') ? 'is-invalid' : '' }}" type="text" name="ip_allocation_type" id="ip_allocation_type" value="{{ old('ip_allocation_type', '') }}">
            ...
            <div class="col-sm">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('dmz') ? 'is-invalid' : '' }}" type="text" name="dmz" id="dmz" value="{{ old('dmz', '') }}">
                    @if($errors->has('dmz'))
                        <div class="invalid-feedback">
                            {{ $errors->first('dmz') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('wifi') ? 'is-invalid' : '' }}" type="text" name="wifi" id="wifi" value="{{ old('wifi', '') }}">
                    @if($errors->has('wifi'))
                        <div class="invalid-feedback">
                            {{ $errors->first('wifi') }}
                        </div>
