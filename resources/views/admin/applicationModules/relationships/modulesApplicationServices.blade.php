...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-modulesApplicationServices">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.applicationService.fields.id') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-modulesApplicationServices:not(.ajaxTable)').DataTable({ buttons: dtButtons })
