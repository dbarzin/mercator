...
@section('title')
    {{ trans('global.edit') }} {{ $wifiTerminal->name }}
@endsection

@section('content')

    <form method="POST" action="{{ route("admin.wifi-terminals.update", [$wifiTerminal->id]) }}"
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea
                                    ...
                                    name="description"
                                    id="description">{!! old('description', $wifiTerminal->description) !!}</textarea>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('address_ip') ? 'is-invalid' : '' }}" type="text"
                               ...
                               value="{{ old('address_ip', $wifiTerminal->address_ip) }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select id="vendor-selector" class="form-control vendor-selector" name="vendor">
                                <option>{{ old('vendor', $wifiTerminal->vendor) }}</option>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select id="product-selector" class="form-control" name="product">
                                <option>{{ old('name', $wifiTerminal->product) }}</option>
                            </select>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select id="version-selector" class="form-control" name="version">
                                <option>{{ old('version', $wifiTerminal->version) }}</option>
                            </select>
