...
@section('content')
    ...
    <form method="POST" action="{{ route("admin.physical-routers.update", [$physicalRouter->id]) }}"
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="required" for="name">{{ trans('cruds.physicalRouter.fields.name') }}</label>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label class="recommended1"
                                   for="type">{{ trans('cruds.physicalRouter.fields.type') }}</label>
                ...
                <div class="form-group">
                    <label class="recommended1"
                           for="description">{{ trans('cruds.physicalRouter.fields.description') }}</label>
                    <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}"
                              name="description"
                              id="description">{!! old('description', $physicalRouter->description) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('vlans') ? 'is-invalid' : '' }}" name="vlans[]"
                            id="vlans" multiple>
        ...
        <div class="form-group">
            <a id="btn-cancel" id="btn-cancel" class="btn btn-default"
               href="{{ route('admin.physical-routers.index') }}">
