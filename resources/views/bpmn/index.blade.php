...
@section('content')
        ...
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a id="btn-new" class="btn btn-success" href="{{ route('admin.bpmn.create') }}">
                    {{ trans('global.add') }} {{ trans('bpmn::content.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
    <div class="card">
        <div class="card-header">
            {{ trans('bpmn::content.title') }} {{ trans('global.list') }}
        </div>
            ...
            <div class="table-responsive">
                <table id="dataTable" class="table table-bordered table-striped table-hover datatable">
                    ...
                    <tr>
                        ...
                        <th width="80%">
                            {{ trans('bpmn::content.fields.name') }}
                        </th>
                        <th width="20%">
                            {{ trans('bpmn::content.fields.type') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                    ...
                    @foreach($graphs as $graph)
                        <tr data-entry-id="{{ $graph->id }}">
                            ...
                            <td nowrap>
                                <a class="btn btn-xs btn-info" href="{{ route('admin.bpmn.raw', $graph->id) }}">
                                   RAW
                                </a>
