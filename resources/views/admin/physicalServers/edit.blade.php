        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $physicalServer->name) }}" required autofocus/>
                    @if($errors->has('name'))
        ...
        <div class="row">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input class="form-control datetime" type="date" name="install_date" id="install_date" value="{{ old('install_date', $physicalServer->install_date) }}">
            ...
            <div class="col-sm">
                <div class="form-group">
                    ...
                    <input class="datetime form-control" type="date" id="update_date" name="update_date" value="{{ old('update_date', $physicalServer->update_date) }}">
		...
		[
            {
                ...
                imgWidth: '120px',
                imgHeight: '120px',
                selected: {{ $physicalServer->icon_id === null ? "true" : "false"}},
            },
            @foreach($icons as  $icon)
            {
                ...
                imgWidth: '120px',
                imgHeight: '120px',
                selected: {{ $physicalServer->icon_id === $icon ? "true" : "false" }},
            },
            @endforeach
        ];
