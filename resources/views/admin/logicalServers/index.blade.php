...
>
<td></td>
<td><a href="{{ route('admin.logical-servers.show', $logicalServer->id) }}">{{ $logicalServer->name }}</a></td>
...
<a href="{{ route('admin.clusters.show', $logicalServer->cluster->id) }}">{{ $logicalServer->cluster->name }}</a>
@endif
...
<a class="btn btn-xs btn-primary" href="{{ route('admin.logical-servers.show', $logicalServer->id) }}">{{ trans('global.view') }}</a>
@endcan
@can('logical_server_edit')
<a class="btn btn-xs btn-info" href="{{ route('admin.logical-servers.edit', $logicalServer->id) }}">{{ trans('global.edit') }}</a>
@endcan
