...
# system deps
RUN apk update && apk add curl nano bash ssmtp graphviz fonts-freefont ca-certificates sqlite sqlite-dev postgresql12 postgresql12-dev nginx gettext supervisor
