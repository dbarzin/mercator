...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-wanLans">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.lan.fields.id') }}
                        </th>
                        <th>
                            {{ trans('cruds.lan.fields.name') }}
                        </th>
                        <th>
                            {{ trans('cruds.lan.fields.man') }}
                        </th>
                        <th>
                            {{ trans('cruds.lan.fields.wan') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
...
@endcan
  ...
  $('.datatable-wanLans:not(.ajaxTable)').DataTable({ buttons: dtButtons })
