                    ...
                    <div class="col-8">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text"
                                   name="name" id="name" maxlength=64 value="{{ old('name', $dataProcessing->name) }}"
                                   required autofocus/>
                            @if($errors->has('name'))
                    ...
                    <div class="col-4">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2-free {{ $errors->has('responsible') ? 'is-invalid' : '' }}"
                                    name="legal_bases[]" id="legal_bases" multiple>
                    ...
                    <table width="100%">
                        <td>
                            <input class="form-check-input" type="checkbox" name="lawfulness_consent" value="1"
                                    {{ $dataProcessing->lawfulness_consent ? "checked" : "" }}>
                        ...
                        <td>
                            <input class="form-check-input" type="checkbox" name="lawfulness_contract" value="1"
                                    {{ $dataProcessing->lawfulness_contract ? "checked" : "" }}>
                        ...
                        <td>
                            <input class="form-check-input" type="checkbox" name="lawfulness_legal_obligation" value="1"
                                    {{ $dataProcessing->lawfulness_legal_obligation ? "checked" : "" }}>
                        ...
                        <td>
                            <input class="form-check-input" type="checkbox" name="lawfulness_vital_interest" value="1"
                                    {{ $dataProcessing->lawfulness_vital_interest ? "checked" : "" }}>
                        ...
                        <td>
                            <input class="form-check-input" type="checkbox" name="lawfulness_public_interest" value="1"
                                    {{ $dataProcessing->lawfulness_public_interest ? "checked" : "" }}>
                        ...
                        <td>
                            <input class="form-check-input" type="checkbox" name="lawfulness_legitimate_interest"
                                   value="1"
                                    {{ $dataProcessing->lawfulness_legitimate_interest ? "checked" : "" }}>
...
ok
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.dataProcessing.fields.update_date_helper') }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="recommended"
                           for="controls">{{ trans('cruds.dataProcessing.fields.documents') }}</label>
