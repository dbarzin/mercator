    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.security-devices.update", [$securityDevice->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $securityDevice->name) }}" required>
                @if($errors->has('name'))
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '/admin/security-devices/ckmedia', true);
                ...
                data.append('crud_id', {{ $securityDevice->id ?? 0 }});
                xhr.send(data);
              });
            })
        }
