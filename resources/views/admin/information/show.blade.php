...
<div class="card">
    ...
    <div class="card-footer">
        {{ trans('global.created_at') }} {{ $information->created_at->format(trans('global.timestamp')) ?? '' }} |
        {{ trans('global.updated_at') }} {{ $information->updated_at->format(trans('global.timestamp')) ?? '' }} 
    </div>
</div>
