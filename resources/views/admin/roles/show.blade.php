...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-2">
                <label class="form-check-label" for="for_name}"><b>{{ trans('cruds.role.fields.title') }}</b></label>
    ...
    <!------------------------------------------------------------------------------------------------------------->
    <div class="card-header">
        <label>{{ trans('panel.menu.tools') }}</label>
    </div>
    <!------------------------------------------------------------------------------------------------------------->
    <div class="card-body">
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <div class="form-switch">
                        <input class="form-check-input" type="checkbox" disabled name="permissions[]" data-check="profile_password_edit" id="profile_password_edit" value="256" {{ in_array('profile_password_edit', old('permissions', [])) || $role->permissions->contains(256) ? 'checked' : '' }}>
