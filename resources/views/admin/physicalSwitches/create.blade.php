    ...
    <div class="card-body">
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', '') }}" required  maxlength="64"/>
                    @if($errors->has('name'))
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('networkSwitches') ? 'is-invalid' : '' }}" name="networkSwitches[]" id="networkSwitches" multiple>
