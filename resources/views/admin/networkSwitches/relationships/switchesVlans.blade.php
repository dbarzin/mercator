...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-switchesVlans">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.vlan.fields.id') }}
                        </th>
                        <th>
                            {{ trans('cruds.vlan.fields.name') }}
                        </th>
                        <th>
                            {{ trans('cruds.vlan.fields.switches') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($vlans as $key => $vlan)
                        <tr data-entry-id="{{ $vlan->id }}">
                            ...
                            <td>
                                @foreach($vlan->switches as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-switchesVlans:not(.ajaxTable)').DataTable({ buttons: dtButtons })
