...
return [
    ...
    'adminUser' => [
        ...
        'fields' => [
            ...
            'description_helper' => '',
            'domain' => 'Domaine',
            'domain_helper' => "Domaine dans lequel l'utilisateur est défini",
        ],
        'title' => 'Utilisateurs',
    ...
    'logicalServer' => [
        ...
        'fields' => [
            ...
            'domain' => 'Domaine',
            'domain_helper' => 'Domaine d\'administration du serveur',
            'description' => 'Description',
            'description_helper' => '',
            'cpu' => 'CPU',
    ...
    'securityDevice' => [
        'fields' => [
            ...
            'physical_security_devices_helper' => 'Liste des dispositifs de sécurité physique sur lequel ce dispositif logique est installé',
            'applications' => 'Applications',
            'applications_helper' => 'Liste des application installées sur le dispositif',
        ],
