        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text"
                                   name="name" id="name" value="{{ old('name', $container->name) }}" required
                    ...
                    <div class="col-sm-5">
                        <div class="form-group">
                            <label for="attributes">{{ trans('cruds.container.fields.attributes') }}</label>
                            <select class="form-control select2-free-tags {{ $errors->has('attributes') ? 'is-invalid' : '' }}"
                                    name="attributes[]" id="attributes" multiple>
                                @foreach($attributes_list as $a)
                                    <option {{ ( (old('attributes')!=null) && in_array($a,old('attributes'))) || in_array($a, array_filter(explode(' ', (string) $container->attributes))) ? 'selected' : '' }}>{{ $a }}</option>
                                @endforeach
                            </select>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.container.fields.attributes_helper') }}</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select id="iconSelect"
                                    ...
                                    data-selected="{{ $container->icon_id ?? '-1' }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="recommended"
                                   for="databases">{{ trans('cruds.container.fields.databases') }}</label>
