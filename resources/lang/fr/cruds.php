...
return [
    ...
    "application" => [
        ...
        "fields" => [
	        ...
	        "major_events" => "Évènements majeurs",
	        "major_events_add" => "Ajouter l'évènement",
	        "major_events_button" => "Voir tous les évènements",
	        "major_events_helper" => "Évènements majeurs de l'application",
	        "major_events_last" => "Dernier évènement : ",
	        "major_events_placeholder" => "Description de l'évènement...",
            "entities" => "Entités",
