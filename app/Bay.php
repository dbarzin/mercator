 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Peripheral[] $bayPeripherals
 * @property-read int|null $bay_peripherals_count
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\PhysicalRouter[] $bayPhysicalRouters
 * @property-read int|null $bay_physical_routers_count
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\PhysicalSecurityDevice[] $bayPhysicalSecurityDevices
 * @property-read int|null $bay_physical_security_devices_count
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\PhysicalServer[] $bayPhysicalServers
 * @property-read int|null $bay_physical_servers_count
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\PhysicalSwitch[] $bayPhysicalSwitches
 * @property-read int|null $bay_physical_switches_count
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\StorageDevice[] $bayStorageDevices
