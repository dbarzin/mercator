    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.workstations.update", [$workstation->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text" name="type" id="type" value="{{ old('type', $workstation->type) }}">
                @if($errors->has('type'))
                    <div class="invalid-feedback">
                        {{ $errors->first('type') }}
                    </div>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '/admin/workstations/ckmedia', true);
                ...
                data.append('crud_id', {{ $workstation->id ?? 0 }});
                xhr.send(data);
              });
            })
        }
