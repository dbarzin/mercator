        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $workstation->name) }}" required autofocus/>
                    @if($errors->has('name'))
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <select class="form-control select2-free {{ $errors->has('type') ? 'is-invalid' : '' }}" name="status" id="status">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control select2-free {{ $errors->has('manufacturer') ? 'is-invalid' : '' }}" name="manufacturer" id="manufacturer">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control select2-free {{ $errors->has('model') ? 'is-invalid' : '' }}" name="model" id="model">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('serial_number') ? 'is-invalid' : '' }}" type="text" name="serial_number" id="serial_number" value="{{ old('serial_number', $workstation->serial_number) }}"/>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('other_user') ? 'is-invalid' : '' }}" type="text" name="other_user" id="other_user" value="{{ old('other_user', $workstation->other_user) }}">
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('entity') ? 'is-invalid' : '' }}" name="network_id" id="network_id">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('address_ip') ? 'is-invalid' : '' }}" type="text" name="mac_address" id="mac_address" value="{{ old('mac_address', $workstation->mac_address) }}">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select class="form-control select2-free {{ $errors->has('network_port_type') ? 'is-invalid' : '' }}" name="network_port_type" id="network_port_type">
		...
		[
            {
                ...
                imgWidth: '120px',
                imgHeight: '120px',
                selected: {{ $workstation->icon_id === null ? "true" : "false"}},
            },
            @foreach($icons as  $icon)
            {
                ...
                imgWidth: '120px',
                imgHeight: '120px',
                selected: {{ $workstation->icon_id === $icon ? "true" : "false" }},
            },
            @endforeach
        ];
