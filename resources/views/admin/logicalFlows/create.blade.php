            ...
            <div class="row">
                <div class="col-sm-1">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('protocol') ? 'is-invalid' : '' }}" type="text" name="protocol" id="protocol" value="{{ old('protocol') }}" required>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('source_ip_range') ? 'is-invalid' : '' }}" type="text" name="source_ip_range" id="source_ip_range" value="{{ old('source_ip_range') }}" required>
                ...
                <div class="col-sm-1">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('source_port') ? 'is-invalid' : '' }}" type="text" name="source_port" id="source_port" value="{{ old('source_port') }}">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('dest_ip_range') ? 'is-invalid' : '' }}" type="text" name="dest_ip_range" id="dest_ip_range" value="{{ old('dest_ip_range') }}" required>
