...
INSERT INTO `activity_process` (`process_id`, `activity_id`) VALUES (1,1),(1,2),(2,3),(2,4),(3,2),(3,5),(5,4),(6,4),(7,3),(8,4),(9,3),(1,10),(1,13),(2,13),(1,14),(2,14),(1,15),(2,15),(1,16),(2,16),(1,17),(2,17);
...
INSERT INTO `buildings` (`id`, `name`, `description`, `created_at`, `updated_at`, `deleted_at`, `site_id`, `camera`, `badge`) VALUES (1,'ROOM 100','<p>Description de la salle 100</p>','2020-06-21 04:37:21','2023-01-12 17:07:38',NULL,1,0,0),(2,'ROOM 200','<p>Description de la salle 200</p>','2020-06-21 04:37:36','2023-01-12 17:08:17',NULL,1,0,0),(3,'ROOM 300','<p>Description du building 3</p>','2020-06-21 04:37:48','2023-01-12 16:36:36',NULL,2,0,0),(4,'ROOM 400','<p>Description de la salle 400</p>','2020-06-21 04:38:03','2023-01-12 16:37:09',NULL,2,0,0),(5,'ROOM 500','<p>Description de la salle 500</p>','2020-06-21 04:38:16','2023-01-12 16:37:27',NULL,3,0,0),(6,'Test building','<p>Description</p>','2020-07-24 19:12:48','2020-07-24 19:14:08','2020-07-24 19:14:08',4,NULL,NULL),(7,'ROOM 000','<p>Description de la salle triple zéro</p>','2020-08-21 13:10:15','2024-05-23 15:23:14',NULL,1,0,0),(8,'test','<p>test</p>','2020-11-06 13:44:22','2020-11-06 14:26:18','2020-11-06 14:26:18',NULL,1,0),(9,'test2','<p>test2</p>','2020-11-06 13:59:45','2020-11-06 14:06:50','2020-11-06 14:06:50',NULL,NULL,NULL),(10,'test3','<p>fdfsdfsd</p>','2020-11-06 14:07:07','2020-11-06 14:26:18','2020-11-06 14:26:18',NULL,NULL,NULL),(11,'test4',NULL,'2020-11-06 14:25:52','2020-11-06 14:26:18','2020-11-06 14:26:18',NULL,0,0),(12,'ROOM 600','<p>Description de la room 600</p>','2024-05-23 14:55:13','2024-05-23 14:55:45',NULL,8,0,0),(13,'ROOM 700','<p>Description de la room 700</p>','2024-05-23 14:56:06','2024-05-23 15:22:36',NULL,8,0,0);
...
INSERT INTO `certificate_logical_server` (`certificate_id`, `logical_server_id`) VALUES (1,1),(2,1),(7,7),(6,7),(4,5),(3,4);
...
INSERT INTO `logical_flows` (`id`, `name`, `source_ip_range`, `dest_ip_range`, `source_port`, `dest_port`, `protocol`, `description`, `created_at`, `updated_at`, `deleted_at`, `router_id`, `priority`, `action`, `users`, `interface`, `schedule`) VALUES (1,'FLOW1','10.10.10.1/32','10.0.0.33/28',NULL,'80','TCP','<p>Description goes here</p>',NULL,'2024-04-22 14:29:17',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'FLOW2','10.1.1.1/32','10.2.2.2/32',NULL,'80','UDP','<p>Description2</p>','2024-04-09 03:26:40','2024-04-10 03:50:43',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,NULL,'10.1.1.1/32','10.2.2.2/32',NULL,'22','TCP','<p>Description du flux</p>','2024-04-09 03:30:36','2024-04-10 03:50:53',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,'QuickChat','192.168.1.0/24','192.168.2.0/24','1234','5678','tcp','<p>Rapid exchange of gossip</p>','2024-04-22 10:20:44','2024-04-22 10:27:51',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `network_switch_physical_switch` (`network_switch_id`, `physical_switch_id`) VALUES (2,1),(3,4),(1,3),(1,2),(3,8),(3,7);
...
INSERT INTO `physical_router_router` (`router_id`, `physical_router_id`) VALUES (1,1),(5,5);
...
INSERT INTO `physical_router_vlan` (`physical_router_id`, `vlan_id`) VALUES (1,1),(1,3),(2,3),(3,5),(4,6);
...
INSERT INTO `physical_routers` (`id`, `description`, `vendor`, `product`, `version`, `type`, `created_at`, `updated_at`, `deleted_at`, `site_id`, `building_id`, `bay_id`, `name`) VALUES (1,'<p>Routeur prncipal</p>',NULL,NULL,NULL,'Fortinet','2020-07-10 06:58:53','2021-10-12 19:08:21',NULL,1,1,1,'R1'),(2,'<p>Routeur secondaire</p>',NULL,NULL,NULL,'CISCO','2020-07-10 07:19:11','2020-07-25 08:28:17',NULL,2,3,5,'R2'),(3,'<p>Description of R3</p>',NULL,NULL,NULL,'Nortel','2024-05-18 16:46:17','2024-05-18 16:46:17',NULL,2,2,4,'R3'),(4,'<p>Description of R4</p>',NULL,NULL,NULL,'CISCO','2024-05-18 16:47:47','2024-05-18 16:47:47',NULL,3,3,5,'R4'),(5,'<p>Big R5 router</p>',NULL,NULL,NULL,'HAL','2024-05-28 12:13:52','2024-05-28 12:14:30',NULL,3,3,5,'R5');
...
INSERT INTO `processes` (`id`, `name`, `description`, `owner`, `security_need_c`, `in_out`, `created_at`, `updated_at`, `deleted_at`, `macroprocess_id`, `security_need_i`, `security_need_a`, `security_need_t`) VALUES (1,'Processus 1','<p>Description du processus 1</p>','Ched',3,'<ul><li>pommes</li><li>poires</li><li>cerise</li></ul>','2020-06-17 14:36:24','2024-04-28 08:17:53',NULL,1,2,3,1),(2,'Processus 2','<p>Description du processus 2</p>','Ched',3,'<p>1 2 3 4 5 6</p>','2020-06-17 14:36:58','2021-09-22 10:59:14',NULL,10,4,2,4),(3,'Processus 3','<p>Description du processus 3</p>','Johan',3,'<p>a,b,c</p><p>d,e,f</p>','2020-07-01 15:50:27','2021-08-17 08:22:13',NULL,2,2,3,1),(4,'Processus 4','<p>Description du processus 4</p>','Paul',4,'<ul><li>chaussettes</li><li>pantalon</li><li>chaussures</li></ul>','2020-08-18 15:00:36','2021-08-17 08:22:29',NULL,2,2,2,2),(5,'totoat','<p>tto</p>',NULL,1,'<p>sgksdùmfk</p>','2020-08-27 13:16:56','2020-08-27 13:17:01','2020-08-27 13:17:01',1,NULL,NULL,NULL),(6,'ptest','<p>description de ptest</p>',NULL,0,'<p>toto titi tutu</p>','2020-08-29 11:10:23','2020-08-29 11:10:28','2020-08-29 11:10:28',NULL,NULL,NULL,NULL),(7,'ptest2','<p>fdfsdfsdf</p>',NULL,1,'<p>fdfsdfsd</p>','2020-08-29 11:16:42','2020-08-29 11:17:09','2020-08-29 11:17:09',1,NULL,NULL,NULL),(8,'ptest3','<p>processus de test 3</p>','CHEM - Facturation',3,'<p>dsfsdf sdf sdf sd fsd fsd f s</p>','2020-08-29 11:19:13','2020-08-29 11:20:59','2020-08-29 11:20:59',1,NULL,NULL,NULL),(9,'Processus 5','<p>Description du cinquième processus</p>','Paul',4,'<ul><li>chat</li><li>chien</li><li>poisson</li></ul>','2021-05-14 07:10:02','2021-09-22 10:59:14',NULL,10,3,2,3),(10,'Proc 6',NULL,NULL,0,NULL,'2021-10-08 19:18:28','2021-10-08 19:28:38','2021-10-08 19:28:38',NULL,0,0,0),(11,'Process empty',NULL,NULL,0,NULL,'2023-12-04 08:13:37','2024-04-28 08:18:10','2024-04-28 08:18:10',NULL,0,0,0);
...
INSERT INTO `relation_values` (`relation_id`, `date_price`, `price`, `created_at`, `updated_at`) VALUES (15,'2020-01-01',123.00,'2024-04-06 11:58:58','2024-04-06 11:58:58'),(4,'2023-04-06',950000.00,'2024-04-06 11:59:47','2024-04-06 11:59:47'),(4,'2024-04-01',1000000.00,'2024-04-06 11:59:47','2024-04-06 11:59:47'),(3,'0022-01-01',150000.00,'2024-04-06 12:00:55','2024-04-06 12:00:55'),(3,'2023-01-01',175000.00,'2024-04-06 12:00:55','2024-04-06 12:00:55'),(3,'2024-01-01',20000.00,'2024-04-06 12:00:55','2024-04-06 12:00:55'),(13,'2024-04-06',100.00,'2024-04-06 12:18:56','2024-04-06 12:18:56'),(13,'2020-01-01',95.00,'2024-04-06 12:18:56','2024-04-06 12:18:56'),(7,'2001-01-01',800000.00,'2024-05-02 09:25:57','2024-05-02 09:25:57'),(7,'2021-04-01',700000.00,'2024-05-02 09:25:57','2024-05-02 09:25:57'),(7,'2024-04-01',950000.00,'2024-05-02 09:25:57','2024-05-02 09:25:57');
...
INSERT INTO `routers` (`id`, `name`, `description`, `rules`, `created_at`, `updated_at`, `deleted_at`, `ip_addresses`, `type`) VALUES (1,'LROUT_00','<p>Description of master router 00</p>','<p>liste des règles dans //serveur/liste.txt</p>','2020-07-13 17:32:25','2024-05-19 03:25:55',NULL,'10.50.1.1, 10.60.1.1, 10.70.1.1','Logcal01'),(2,'LROUT_01','<p>Description of router 01</p>','<p>list of rules :&nbsp;</p><ul><li>a</li><li>b</li><li>c</li><li>d</li></ul>','2021-09-21 13:47:47','2024-05-18 08:12:55',NULL,'10.10.0.1, 10.20.0.1, 10.30.0.1',NULL),(3,'LROUT_02','<p>This is the second router</p>',NULL,'2021-09-21 13:52:16','2023-02-01 15:58:09',NULL,'10.30.1.1, 10.40.1.1',NULL),(4,'LROUT_04','<p>Description of logical router 04</p>',NULL,'2024-03-14 16:02:46','2024-03-14 16:08:11',NULL,'127.0.0.1, 127.0.0.1',NULL),(5,'LROUT_05','<p>Description of logical router 05</p>',NULL,'2024-03-14 16:05:38','2024-03-14 16:05:38',NULL,'232.123.2.2, 1.1.1.1, 2.2.2.2',NULL),(6,'Test',NULL,NULL,'2024-05-18 08:11:26','2024-05-18 08:12:25','2024-05-18 08:12:25',NULL,NULL),(7,'Test2',NULL,NULL,'2024-05-18 08:12:14','2024-05-18 08:12:29','2024-05-18 08:12:29',NULL,NULL);
...
-- Dump completed on 2024-05-31 11:45:17
